...
public class ProductCompareDataDTO implements Comparable<ProductCompareDataDTO>{
    ...
    public String toString() {
        costAmountInStock = stockDetailsDTO.getAvailableStock() * costPrice;
        ...
        return Utils.normalizeStringLenght(20,sku) + "   " + Utils.normalizeStringLenght(15,ean) + "   " + Utils.normalizeStringLenght(50,productName) + "  " + competitorsString + "\n"+
                "CostPrice: " +  Utils.normalizeStringLenght(5, costPrice+"") + "€   Stock: " + Utils.normalizeStringLenght(3, stockDetailsDTO.getAvailableStock()+"") +  "   Reserved: " + Utils.normalizeStringLenght(3, stockDetailsDTO.getShopifyPaidReservations()+"") + "     SellWithoutStock: " +  Utils.normalizeStringLenght(5,stockDetailsDTO.getContinueToSellOutOfStock()+"") +
    ...
    public int compareTo(ProductCompareDataDTO o) {
        try {
            ...
            if (o.costAmountInStock == null) {
                o.setCostAmountInStock(o.getCostPrice()* o.getStockDetailsDTO().getAvailableStock());
            }

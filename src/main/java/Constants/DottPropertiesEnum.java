...
public enum DottPropertiesEnum {
    ...
    TAGS ("tags", "H", 7),
    PRICE_WITHOUT_VAT("priceWithoutVat","I",8),
    PRICE_WITH_VAT("priceWithVAT", "J", 9),
    PREVIOUS_PRICE("previousPrice","K",10),
    SKU ("sku", "L", 11),
    ...
    DottPropertiesEnum(String column_name, String column_letter, int column_number) {
